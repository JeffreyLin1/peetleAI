...
export class OpenAIService {
  ...
  async generateResponse(topic: string): Promise<ChatResponse> {
    try {
      ...
      const systemPrompt = `You are a teacher, and you're explaining topics in a simple and enthusiastic way. Keep explanations engaging but educational. Keep responses under 300 words.`;
